...
class AtomParser extends BaseParser
{
    ...
    public function findFeedDate(SimpleXMLElement $xml, Feed $feed)
    {
        ...
        $feed->setDate($this->dateParser->getDateTime(XmlParser::getValue($updated)));
    }
    ...
    public function findItemPublishedDate(SimpleXMLElement $entry, Item $item, Feed $feed)
    {
        ...
        $item->setPublishedDate(!empty($date) ? $this->dateParser->getDateTime((string) current($date)) : null);
    }
    ...
    public function findItemUpdatedDate(SimpleXMLElement $entry, Item $item, Feed $feed)
    {
        ...
        $item->setUpdatedDate(!empty($date) ? $this->dateParser->getDateTime((string) current($date)) : null);
    }
